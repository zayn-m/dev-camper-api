...
// @desc    Get all courses of courses
...
exports.getCourse = asyncHandler(async (req, res, next) => {
    ...
    if (!course)
        return next(
            new ErrorResponse(
                "No course with id of " + req.params.id + " found",
                404
            )
        );
...
exports.addCourse = asyncHandler(async (req, res, next) => {
    ...
    if (
        ...
        return next(
            new ErrorResponse("User is not authorized to add a course", 401)
        );
    }
...
exports.deleteCourse = asyncHandler(async (req, res, next) => {
    ...
    if (!course)
        return next(
            new ErrorResponse(
                "No course with id of " + req.params.bootcampId + " found",
                404
            )
        );
